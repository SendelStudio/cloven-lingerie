...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 59dBVJLv7oAn/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: jcahyWLRC9zE/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uVtGa)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__z999H)}
              />
            </React.Fragment>
          ),
          value: args.children
