...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dyTWxfjTmtIP/css

import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: MDqb4gy5thwi/icon
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___9ZsjQ, {
            [sty.freeBoxcolors_white___9ZsjQpth5Z]: hasVariant(
              $state,
              "colors",
              "white"
            ),
            [sty.freeBoxcolors_white_showStartIcon___9ZsjQpth5ZVyr1S]:
              hasVariant($state, "colors", "white") &&
              hasVariant($state, "showStartIcon", "showStartIcon"),
            [sty.freeBoxiconOnly___9ZsjQVgxg]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon___9ZsjQs3ROe]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon___9ZsjQvyr1S]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large___9ZsjQomd45]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___9ZsjQpnN9]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon10Icon
                className={classNames(projectcss.all, sty.svg__vwrqQ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__efUer, {
            [sty.freeBoxshowEndIcon__efUers3ROe]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__efUerpnN9]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <Icon10Icon
                    className={classNames(projectcss.all, sty.svg__xVajp)}
                    role={"img"}
                  />
                ),
