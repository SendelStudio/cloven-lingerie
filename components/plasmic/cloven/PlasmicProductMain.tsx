...
import sty from "./PlasmicProductMain.module.css"; // plasmic-import: FMd8rN3nhwgp/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___4Uhwb)}
      >
        <h3
        ...
        >
          <ProductTextField
            className={classNames(
              "__wab_instance",
              sty.productTextField__kT4U7
            )}
            field={"name"}
          />
        </h3>
        <div className={classNames(projectcss.all, sty.freeBox__uiz8)}>
          <ProductTextField
            className={classNames(
              "__wab_instance",
              sty.productTextField__cfyi1
            )}
            field={"description"}
          />
        </div>
