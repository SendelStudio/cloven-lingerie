...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: cIEcbz6UmdSP/component
import Select__Option from "../../Select__Option"; // plasmic-import: oFpvCjJcglyn/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: 59dBVJLv7oAn/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: jcahyWLRC9zE/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: o-4tvtNjEB1w/icon
import ChevronUpSvgIcon from "./icons/PlasmicIcon__ChevronUpSvg"; // plasmic-import: DxWRCoTDE8RG/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option___3BoNu)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__qquu2)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
